            ...
            <div className="w-full px-8 md:px-12 h-20 flex items-center justify-between relative">
                ...
                <div className="hidden lg:flex items-center absolute left-1/2 -translate-x-1/2 w-1/3 max-w-sm">
                    <input
                        ...
                        className="w-full pl-6 pr-10 py-2.5 rounded-full border border-gray-200 bg-white text-sm text-gray-600 focus:outline-none focus:border-[#F51046] shadow-sm"
                    />
                ...
                <div className="hidden lg:flex items-center gap-4">
                    ...
                    <button className="px-6 py-2 rounded-full bg-[#F51046] text-white text-sm font-bold hover:bg-red-600 transition-colors shadow-lg shadow-red-200">
                        Enroll Now
                    </button>
                </div>
            </div>
