                    ...
                    >
                        {projects.map((project, idx) => (
                            <motion.div
                                ...
                                className="group relative bg-[#0a0c14] rounded-3xl overflow-hidden flex flex-col h-[500px]"
                            >
                                {/* Top Image Area */}
                                ...
                                {/* Content */}
                                <div className="p-8 flex-grow flex flex-col justify-end bg-[#0a0c14]">
                                    <h3 className="text-2xl font-bold text-white mb-4 leading-tight">
                                        {project.title}
                                    </h3>
                                    <div className="inline-flex">
                                        <span className="bg-[#ccff00] text-black text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-1">
                                            No coding required ⚡
                                        </span>
                                    </div>
                                </div>
